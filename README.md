...
## Example Output (Live downloads successful)

Here's what you should see after executing `nordvik_analysis.py` without encountering any API issues:

<p align="center">
  <img src="https://github.com/Q-Fin/nordvik-portfolio-case/blob/main/assets/Example_Terminal_Output.png" alt="Windows Terminal Output" width="700"><br>
  <sub>Example Windows Terminal Output After Executing `python nordvik_analysis.py` Command</sub>
</p>
